...
public class Planning_Unit_SP_011_Step extends Page {
...
//    }
    ...
    public void click_planning_button() throws InterruptedException {
        getPlanning_Unit_SP_011().setPlanningButton();
        Thread.sleep(5000);
    }
